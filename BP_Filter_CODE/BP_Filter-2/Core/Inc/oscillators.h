...
/*-------------------------------------------------------*/
enum timbre { BASIC_SAW = 0, BASIC_SQR, BASIC_TRIANG, BASIC_SINE, MORPHSAW, PULSE, LAST_SOUND };
...
float_t BasicSine(Oscillator_t * op);
float_t MorphingSaw(Oscillator_t * op);
float_t PulseWave(Oscillator_t * op);
float_t FLTR_Triangle_LFO(Oscillator_t * op);
